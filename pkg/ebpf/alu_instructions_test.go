...
func TestAluImmInstructionGenerationAndEncoding(t *testing.T) {
	tests := []struct {
		...
		},
		{
			...
			instruction:  Arsh64(RegR9, -65535),
			wantDstReg:   RegR9,
			wantImm:      int32(-65535),
			wantOpcode:   AluArsh,
			wantClass:    InsClassAlu64,
